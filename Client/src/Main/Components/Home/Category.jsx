                ...
                <div className="  flex flex-nowrap gap-5 ">
                    {
                        CategoryData.map((item, i) => {
                            ...
                            return (
                                <Link to={`/products?category=${title}`} key={i} className=" cursor-pointer hover:shadow-xl h-full w-64 py-12 rounded-md px-16 bg-gray-100 flex flex-col gap-5 text-center ">
